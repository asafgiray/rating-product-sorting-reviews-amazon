...
df["overall"].mean() # 4.58, hiçbir işlem yapmadan önceki hali
...
df = df[["reviewerName", "overall", "summary", "helpful_yes", "helpful_no", "total_vote", "reviewTime"]] #kullanılmayan kolonları attık
df.head()
